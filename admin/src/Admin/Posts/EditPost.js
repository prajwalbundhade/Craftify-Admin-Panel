...
//       try {
//         const response = await axios.get(`http://craftifyservice.online:5000/api/posts/${id}`);
...
//     try {
//       const response = await axios.put(`http://craftifyservice.online:5000/api/posts/${id}`, formData);
